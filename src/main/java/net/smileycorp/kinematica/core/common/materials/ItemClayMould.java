...
public class ItemClayMould extends Item implements IMetaItem {
	
	private String type;
	private String[] variants = {"Blank", "Ingot", "Gear", "Rod"};
	
	public ItemClayMould(String type) {
		super();
	...
	private String getDisplayName(int meta) {
		...
		result += " ";
		result += I18n.translateToLocal("localisation.Mould").trim();
		return result;
	}
