...
public class WorldGenPegmatite extends WorldGenerator {
	private final IBlockState blockPegmatite = KineWorld.PEGMATITE.getDefaultState();
    /** The number of blocks to generate. */
    private final int numberOfBlocks = 65;
                            ...
                            for (int j2 = l; j2 <= k1; ++j2) {
                                ...
                                if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D) {
                                    ...
                                    if (state.getBlock()==Blocks.STONE)  {
                                        world.setBlockState(blockpos, this.blockPegmatite, 18);
                                    }
                                }
                            }
                        }
