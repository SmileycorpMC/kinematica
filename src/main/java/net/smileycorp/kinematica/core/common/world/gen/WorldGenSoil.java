...
public class WorldGenSoil extends WorldGenerator {
	private final IBlockState blockSoil;
	private final IBlockState blockGrass;
    /** The number of blocks to generate. */
    private final int numberOfBlocks = 35;
    
    public WorldGenSoil(Block soil, Block grass) {
    	blockSoil=soil.getDefaultState();
