...
public class BauxiteSoilGen extends WorldGenerator {
	private final IBlockState blockBauxite = WorldBlocks.BAUXITE_SOIL.getDefaultState();
	private final IBlockState blockGrass = WorldBlocks.BAUXITE_GRASS.getDefaultState();
    /** The number of blocks to generate. */
    private final int numberOfBlocks = 35;
                            ...
                            for (int j2 = l; j2 <= k1; ++j2) {
                                ...
                                if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D) {
                                    ...
                                    if (state.getBlock()==Blocks.DIRT)  {
                                        world.setBlockState(blockpos, this.blockBauxite, 2);
