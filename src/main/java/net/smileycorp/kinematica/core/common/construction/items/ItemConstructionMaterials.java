...
public class ItemConstructionMaterials extends Item implements IMetaItem {
	
	final String[] variants = {"Refractory_Brick"};
	
	public ItemConstructionMaterials() {
		super();
		String name = "Construction_Materials";
