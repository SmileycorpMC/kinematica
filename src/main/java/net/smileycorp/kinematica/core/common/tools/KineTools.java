...
public class KineTools {
	...
	public static ToolSet COPPER = new ToolSet("copper", new CustomTier(141, 6.0F, 4.0F, 1, 7, ()->Ingredient.of(Tags.Items.INGOTS_COPPER)), CreativeModeTabs.f_256837_, ITEMS);
