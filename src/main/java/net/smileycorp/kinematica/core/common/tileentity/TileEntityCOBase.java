...
public class TileEntityCOBase extends TileEntity implements ITickable, ISidedInventory {
	...
	protected TileEntityCOBase(String name) {
		this.name=name;
	}
	...
	public String getName() {
		return this.hasCustomName() ? this.customName : "container.compositeores." + name;
	}
