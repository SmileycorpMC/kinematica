...
public class ContainerKilnChamber extends Container {
	...
	public ContainerKilnChamber(InventoryPlayer playerInventory, IInventory blockInventory) {
		super();
		this.inventory = blockInventory;
		this.addSlotToContainer(new Slot(inventory, 0, 47, 34));
		this.addSlotToContainer(new Slot(inventory, 1, 65, 34));
		this.addSlotToContainer(new SlotItemOutput(playerInventory.player, inventory, 3, 124, 34));
