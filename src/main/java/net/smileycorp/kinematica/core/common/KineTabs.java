...
public class KineTabs {
	...
	public static CreativeTabs MATERIALS = new CreativeTabs(ModDefinitions.getName("Materials")) {
		...
		public ItemStack getIconItemStack() {
			if (iconItemStack == null) iconItemStack = chooseItem(this);
			else if (ModDefinitions.ticker % 35 == 0) if (rand.nextInt(12) == 0) iconItemStack = chooseItem(this);
	...
	public static final CreativeTabs ORES = new CreativeTabs(ModDefinitions.getName("Ores")) {
		...
		public ItemStack getIconItemStack(){
			if (iconItemStack == null) iconItemStack = chooseItem(this);
			else if (ModDefinitions.ticker % 35 == 0) if (rand.nextInt(12) == 0)
				iconItemStack = chooseItem(this);
