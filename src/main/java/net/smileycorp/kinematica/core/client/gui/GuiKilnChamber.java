...
public class GuiKilnChamber extends GuiContainer {
	
	protected static final ResourceLocation guiTexture = 
			ModDefinitions.getResource("textures/gui/container/kiln_chamber.png");
	 private final InventoryPlayer inventory;
	    private final IInventory tile;

	    public GuiKilnChamber(InventoryPlayer inventory, IInventory tile, Container container)
	    {
	        super(container);
	    ...
	    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
	    {
	        ...
	        if (((TileEntityKiln)tile).isBurning())
	        {
	            ...
	            this.drawTexturedModalRect(i + 56, j + 65 - k, 176, 12 - k, 14, k + 1);
	        }

	        int l = this.getCookProgressScaled(24);
	        this.drawTexturedModalRect(i + 86, j + 34, 176, 14, l + 1, 16);
	    }
